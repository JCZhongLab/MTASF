...
CountTestNum::CountTestNum(TdgfMngPtr mng_ptr) {
  convert_ratio_ = mng_ptr->convert_ratio_;  //27.4335215
  max_ptm_mass_ = mng_ptr->max_ptm_mass_;	//1000000
  max_sp_len_ = static_cast<int>(std::round(mng_ptr->max_prec_mass_ * convert_ratio_)); // 2743352
