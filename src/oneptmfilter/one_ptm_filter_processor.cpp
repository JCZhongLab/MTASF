...
void OnePtmFilterProcessor::process() {
  ...
  */
  ...
  int group_spec_num = prsm_para_ptr->getGroupSpecNum(); // 1
  ...
  int thread_num = mng_ptr_->thread_num_; // 1
...
void OnePtmFilterProcessor::processBlock(DbBlockPtr block_ptr, const std::vector<double> & mod_mass_list) {
  ...
  ProteoformPtrVec raw_forms
      = proteoform_factory::readFastaToProteoformPtrVec(db_block_file_name,  // proteins.fasta_target_decoy_0
