...
ExtendMsPtr geneMsThreePtr(DeconvMsPtr deconv_ms_ptr, SpParaPtr sp_para_ptr,
  ...
  double ext_min_mass = sp_para_ptr->getExtendMinMass();  //5000
  std::vector<double> ext_offsets = sp_para_ptr->getExtendOffsets();  //0, -1.00235, 1.00235
  ...
  double min_mass = sp_para_ptr->getMinMass();  //50.0
